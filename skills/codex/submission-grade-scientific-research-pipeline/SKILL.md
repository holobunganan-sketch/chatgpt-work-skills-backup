...
- [execution-contract.md](../.shared/submission-grade-research-core/references/execution-contract.md)
- [workflow-core.md](../.shared/submission-grade-research-core/references/workflow-core.md)
- [language-and-integrity.md](../.shared/submission-grade-research-core/references/language-and-integrity.md)
- [submission-assets.md](../.shared/submission-grade-research-core/references/submission-assets.md)
- [manuscript-gate.md](../.shared/submission-grade-research-core/references/manuscript-gate.md)
...
- Explicitly invoke [$docx](../../../.agents/skills/docx/SKILL.md) when `.docx` outputs are required.
